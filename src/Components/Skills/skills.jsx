        ...
        <>
            ...
            <div class="lg:flex items-center justify-center text-start">
                <div class="w-72 items-center text-start justify-center" style={{ padding: "5px" }}>
                    <div class="w-full h-28 max-w-md px-8 py-4 mt-16 rounded-lg shadow-lg bg-black">
                        <div class="flex justify-center -mt-16 md:justify-end">
                            <img class="object-cover w-20 h-20 border-2 border-blue-500 rounded-full dark:border-blue-400" alt="" src="https://logowik.com/content/uploads/images/visual-studio-code7642.jpg" />
                        </div>
                        <h1 class="mt-2 text-xl font-semibold text-white md:mt-0">Visual Studio<br /> Code</h1>
                    </div>
                </div>
                <div class="w-72 items-center text-start justify-center" style={{ padding: "5px" }}>
                    <div class="w-full h-28 max-w-md px-8 py-4 mt-16 rounded-lg shadow-lg bg-black">
                        <div class="flex justify-center -mt-16 md:justify-end">
                            <img class="object-cover w-20 h-20 border-2 border-blue-500 rounded-full dark:border-blue-400" alt="" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Git_icon.svg/1200px-Git_icon.svg.png" />
                        </div>
                        <h2 class="mt-2 text-xl font-semibold text-white md:mt-0">Git</h2>
                    </div>
                </div>
                <div class="w-72 items-center text-start justify-center" style={{ padding: "5px" }}>
                    <div class="w-full h-28 max-w-md px-8 py-4 mt-16 rounded-lg shadow-lg bg-black">
                        <div class="flex justify-center -mt-16 md:justify-end">
                            <img class="object-cover w-20 h-20 border-2 border-blue-500 rounded-full dark:border-blue-400" alt="" src="https://logowik.com/content/uploads/images/firebase.jpg" />
                        </div>
                        <h2 class="mt-2 text-xl font-semibold text-white md:mt-0">Firebase</h2>
                    </div>
                </div>
            </div>
            <div class="lg:flex items-center justify-center text-start">
                <div class="w-72 items-center text-start justify-center" style={{ padding: "5px" }}>
                    <div class="w-full h-28 max-w-md px-8 py-4 mt-16 rounded-lg shadow-lg bg-black">
                        <div class="flex justify-center -mt-16 md:justify-end">
                            <img class="object-cover w-20 h-20 border-2 border-blue-500 rounded-full dark:border-blue-400" alt="" src="https://pbs.twimg.com/profile_images/1641476962362302464/K8lb6OtN_400x400.jpg" />
                        </div>
                        <h1 class="mt-2 text-xl font-semibold text-white md:mt-0">AWS</h1>
                    </div>
                </div>
                <div class="w-72 items-center text-start justify-center" style={{ padding: "5px" }}>
                    <div class="w-full h-28 max-w-md px-8 py-4 mt-16 rounded-lg shadow-lg bg-black">
                        <div class="flex justify-center -mt-16 md:justify-end">
                            <img class="object-cover w-20 h-20 border-2 border-blue-500 rounded-full dark:border-blue-400" alt="" src="https://logowik.com/content/uploads/images/mysql8604.logowik.com.webp" />
                        </div>
                        <h2 class="mt-2 text-xl font-semibold text-white md:mt-0">MySQL</h2>
                    </div>
                </div>
            </div>
        </>
